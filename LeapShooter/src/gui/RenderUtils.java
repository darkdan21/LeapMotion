...
public class RenderUtils {
    ...
    private void prepareTextures(){
        texPlain = Application3D.getApp().getResources().loadTexture( "res/sprites/spr_plain.png", "tex_plain" );
    }
    //////////////////////////////////////////////////////////////////
    // User Methods
    /**
    ...
    public void drawSpritePartExt( float x, float y, float partX, float partY, float width, float height, Texture tex, float originX, float originY, float xscale, float yscale, GColour colour ){
        tex.bind();
        Application3D.getApp().getActiveShader().setUniformColour( colour );
        Application3D.getApp().getActiveShader().setUniformUVBias((partX)/tex.getWidth(), (partY)/tex.getHeight(),width/tex.getWidth(), height/tex.getHeight() );
        drawQuad( x-originX*xscale, y-originY*yscale, width*xscale, height*yscale );
        Application3D.getApp().getActiveShader().resetUniformUVBias();
    }
